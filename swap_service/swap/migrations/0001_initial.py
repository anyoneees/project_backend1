    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exchange_requests', to='swap.clothingitem')),
                ('requester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requested_exchanges', to='swap.user')),
            ],
        ),
        migrations.AddField(
            model_name='clothingitem',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clothing_items', to='swap.user'),
        ),
    ]
